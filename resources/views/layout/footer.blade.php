<footer class="px-md-3 py-5">
            <div class="row justify-content-between g-0 px-3 px-md-5">
                ...
                <div class="col-3 align-self-start px-3">
                    ...
                    <p class="col-1-h">Gedung Lecture Hall Lt.1</p>
                    <p class="col-1-h">Jl. A.H. Nasution No. 105, Cipadung, Bandung, Jawa Barat</p>
                    <div class="row flex-column flex-wrap col-1-h mt-4">
                        <div class="d-flex flex-wrap col-1-h">
                            <p class="col-md-3 me-3">Email: </p>
                            <p class="col-md-8">-</p>
                        </div>
                        <div class="d-flex flex-wrap col-1-h">
                            <p class="col-md-3 me-3">Youtube: </p>
                            <p class="col-md-8"><a href="https://www.youtube.com/@rumahjurnaluinsunangunungd3648/channels" class="col-auto">Rumah Jurnal UIN Sunan Gunung Djati Bandung</a></p>
                        </div>
                    </div>
